...
const services = [
  {
    ...
    subheading: "Scale Your Agency Without Hiring Internally",
    description:
      "We provide white-label fulfillment and backend support for agencies that want to deliver more while focusing on sales and business growth. Our experienced team works behind the scenes under your brand, allowing you to scale confidently without increasing operational overhead.",
    features: [
...
export default function WhiteLabelServiceDetails() {
  return (
    <section className="relative overflow-hidden bg-white py-12 md:py-16">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,rgba(56,189,248,0.10)_0%,transparent_55%)]" />
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <Briefcase className="h-7 w-7 text-yellow-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
              ...
              <div className="order-1 p-6 md:p-10 lg:p-12 lg:order-2">
                ...
                >
                  ...
                  <div className="mt-2 h-px w-full bg-gradient-to-r from-emerald-500/40 via-sky-500/30 to-transparent" />
                </motion.div>
                ...
                >
                  <motion.a
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="group inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-emerald-600 to-sky-600 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-[0_0_45px_rgba(52,211,153,0.35)]"
                  >
