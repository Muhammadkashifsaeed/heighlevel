...
const services = [
  {
    ...
    subheading: "Professional Branding & Marketing Assets",
    description:
      "Our creative team helps businesses build a memorable brand through premium visual design and marketing assets. From UI/UX design and branding to social media creatives and presentation materials, we create visuals that capture attention, build trust, and drive engagement.",
    features: [
      "UI/UX & Web Design",
...
export default function CreativeServiceDetails() {
  return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <Palette className="h-7 w-7 text-emerald-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
