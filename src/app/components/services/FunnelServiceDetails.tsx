            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 lg:grid-cols-2">
              ...
              <div className="order-1 p-4 sm:p-6 md:p-10 lg:p-12 lg:order-2">
                ...
                <motion.h2
                  ...
                  className="bg-[linear-gradient(90deg,#22c55e,#10b981)] bg-[length:200%_auto] bg-clip-text text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold leading-[1.15] tracking-tight text-transparent"
                >
                  {service.title}
                </motion.h2>
