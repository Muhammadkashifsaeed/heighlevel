...
import { Funnel, Check, ArrowRight } from "lucide-react";

const services = [
  {
    title: "Funnels, Websites & Landing Pages",
    subheading: "High-Converting Digital Assets Built For Growth",
    description:
      "Your website should do more than look good. We build high-converting websites, landing pages, and sales funnels designed to generate qualified leads, increase conversions, improve customer experience, and help businesses grow faster.",
    features: [
...
export default function FunnelServiceDetails() {
  return (
          ...
          >
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                >
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-sky-500/20">
                      <Funnel className="h-4 w-4 text-sky-400" />
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <Funnel className="h-7 w-7 text-blue-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
              ...
              <div className="order-1 p-6 md:p-10 lg:p-12 lg:order-2">
                ...
                >
                  <Funnel className="h-4 w-4 text-emerald-500" />
                ...
                <motion.h2
                  ...
                  className="bg-[linear-gradient(90deg,#22c55e,#10b981)] bg-[length:200%_auto] bg-clip-text text-3xl font-extrabold leading-[1.15] tracking-tight text-transparent md:text-4xl lg:text-5xl"
                >
                  {service.title}
                </motion.h2>
