...
const services = [
  {
    ...
    subheading: "Automate Your Sales, Marketing & Operations",
    description:
      "Our team specializes in building advanced automation systems that reduce manual work and increase conversion rates. From lead nurturing and customer onboarding to appointment reminders and business operations, we create intelligent workflows that run 24/7 and help businesses scale efficiently.",
    features: [
              ...
              <div className="relative order-2 flex items-center justify-center p-6 md:p-10 lg:p-12 lg:order-1">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute inset-4 rounded-full border border-emerald-500/15"
                  />
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-blue-500/15 backdrop-blur-sm">
                      <Workflow className="h-7 w-7 text-blue-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>

              <div className="order-1 p-6 md:p-10 lg:p-12 lg:order-2">
                <motion.div
                  initial={{ opacity: 0, scale: 0.9 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: 0.15 }}
                  className="mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-emerald-500/10 px-4 py-1.5 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_rgba(52,211,153,0.25)]"
                >
                ...
                <motion.h2
                  ...
                  className="cursor-pointer text-3xl font-extrabold leading-[1.15] tracking-tight text-slate-900 transition-colors duration-300 md:text-4xl lg:text-5xl"
                >
                  {service.title}
                </motion.h2>
                ...
                >
                  ...
                  <div className="mt-2 h-px w-full bg-gradient-to-r from-emerald-500/40 via-blue-500/30 to-transparent" />
                </motion.div>
                ...
                >
                  {service.features.map((feature, fIdx) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm transition-all duration-300 hover:border-emerald-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(15,23,42,0.08)]"
                    >
                      ...
                      <span className="text-sm font-medium text-slate-800 transition-colors duration-300 group-hover:text-slate-900">
                        {feature}
                      </span>
                    </motion.div>
                  ))}
                ...
                >
                  <motion.a
                    ...
                    whileTap={{ scale: 0.97 }}
                    className="group inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-emerald-600 to-blue-600 px-6 py-3 text-base font-semibold text-white shadow-lg shadow-emerald-500/25 transition-all duration-300 hover:shadow-[0_0_45px_rgba(52,211,153,0.35)]"
                  >
