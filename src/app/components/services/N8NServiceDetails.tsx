...
const services = [
  {
    ...
    subheading: "Connect Everything. Automate Anything.",
    description:
      "When native integrations aren't enough, N8N unlocks unlimited automation possibilities. Our engineers build custom workflows that connect your CRM, payment systems, communication tools, databases, and third-party applications to automate repetitive tasks and streamline business operations.",
    features: [
...
export default function N8NServiceDetails() {
  return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <Plug className="h-7 w-7 text-emerald-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
