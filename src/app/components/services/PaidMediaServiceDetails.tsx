...
const services = [
  {
    ...
    subheading: "Scale Faster With Data-Driven Advertising",
    description:
      "Our paid media specialists create data-driven advertising campaigns that generate high-quality leads and maximize return on investment. We manage Google Ads, Meta Ads, YouTube campaigns, TikTok advertising, audience targeting, conversion tracking, and landing page optimization to help businesses scale faster.",
    features: [
      "Meta & Google Ad Campaigns",
      "YouTube & TikTok Advertising",
      "Retargeting & Lookalike Audience Strategies",
      "Conversion Pixel Setup",
      "Performance Analytics & Data Reporting",
...
export default function PaidMediaServiceDetails() {
  return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <TrendingUp className="h-7 w-7 text-yellow-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
