...
const services = [
  {
    ...
    subheading: "Content Designed To Capture Attention",
    description:
      "Our creative editors produce engaging short-form videos and premium content designed to increase reach, engagement, and conversions. From social media reels to YouTube Shorts, motion graphics, and AI-enhanced editing, we create content that helps brands stand out across every platform.",
    features: [
      "Short Form Content (Reels / TikTok)",
      "YouTube Shorts Editing",
      "High-Converting Video Ads",
      "VSL & Explainer Video Editing",
...
export default function VideoServiceDetails() {
  return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/15 to-sky-500/15 backdrop-blur-sm">
                      <Video className="h-7 w-7 text-sky-500 md:h-8 md:w-8" />
                    </div>
                  </motion.div>
                </motion.div>
              </div>
